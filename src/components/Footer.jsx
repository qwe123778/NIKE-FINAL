...
const Footer = () => (
  <footer className="border-t border-foreground/10 px-6 md:px-12 py-16">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
      <div>
        <h4 className="font-display text-xl not-italic mb-4">SONACT</h4>
        <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
          Performance is the only aesthetic. We give you the best services.
        </p>
    ...
    <div className="mt-16 pt-8 border-t border-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
      <p className="font-mono-tech text-muted-foreground">© 2026 SONACT, Inc. All rights reserved.</p>
